...
import { generateEmbeddingsBatch, isEmbeddingAvailable } from "./embeddings";
...
// Re-exported pure helpers — split into per-domain files under server/services/rag/
// for navigability; behavior is unchanged. External callers that import these
// names from "../services/rag" keep working unmodified.
export { type QueryType, classifyQueryType, getAdaptiveWeights } from "./rag/query-classification";
export { type QueryRoute, classifyQueryRoute, getStructuredAnswer } from "./rag/structured-route";
export { expandQueryWithSynonyms } from "./rag/synonym-expansion";
export { computeConfidence, reconcileConfidence } from "./rag/confidence";
export { validateConversationHistory, reformulateWithContext } from "./rag/query-reformulation";
import { computeConfidence } from "./rag/confidence";
import { classifyQueryType, getAdaptiveWeights, type QueryType } from "./rag/query-classification";
import { expandQueryWithSynonyms } from "./rag/synonym-expansion";
