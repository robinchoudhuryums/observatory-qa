...
export const CLINICAL_NOTE_TEMPLATES: ClinicalNoteTemplate[] = [
  // ==================== GENERAL MEDICAL ====================
  {
    ...
    category: "preventive",
    description:
      "Comprehensive annual wellness exam with preventive screening review and health maintenance counseling.",
    sections: {
      subjective:
        "Patient presents for annual wellness exam. {{chief_complaint}}. Review of systems: {{review_of_systems}}. Current medications: {{medications}}. Allergies: {{allergies}}. Social history: {{social_history}}. Family history: {{family_history}}.",
      objective:
        "Vitals: BP {{bp}}, HR {{hr}}, Temp {{temp}}, SpO2 {{spo2}}, Weight {{weight}}, Height {{height}}, BMI {{bmi}}. General: Well-appearing, no acute distress. HEENT: Normocephalic, PERRL, oropharynx clear. Neck: Supple, no lymphadenopathy. Cardiovascular: RRR, no murmurs. Lungs: CTA bilaterally. Abdomen: Soft, non-tender, non-distended. Extremities: No edema. Skin: No suspicious lesions. Neuro: A&Ox4, grossly intact.",
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Patient presents with {{chief_complaint}} for {{duration}}. Onset: {{onset}}. Severity: {{severity}}/10. Associated symptoms: {{associated_symptoms}}. Aggravating factors: {{aggravating}}. Alleviating factors: {{alleviating}}. Prior treatment attempted: {{prior_treatment}}.",
      objective:
        "Vitals: BP {{bp}}, HR {{hr}}, Temp {{temp}}, SpO2 {{spo2}}. General: {{general_appearance}}. Focused exam: {{focused_exam_findings}}.",
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Patient returns for follow-up of {{condition}}. Since last visit: {{interval_history}}. Current symptoms: {{current_symptoms}}. Medication compliance: {{medication_adherence}}. Side effects: {{side_effects}}.",
      objective:
        "Vitals: BP {{bp}}, HR {{hr}}, Weight {{weight}}. {{focused_exam}}. Labs/imaging reviewed: {{results_review}}.",
    ...
    defaultCodes: [{ code: "99214", description: "Office visit, established, moderate complexity" }],
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Telehealth visit conducted via {{platform}} (video/audio). Patient reports: {{chief_complaint}}. {{history_of_present_illness}}. Current medications: {{medications}}.",
      objective:
        "Visual assessment via video: {{visual_findings}}. Patient-reported vitals: BP {{bp}}, Temp {{temp}}, HR {{hr}}. Limitations of virtual exam noted: {{exam_limitations}}.",
  ...
  },
  {
    ...
    sections: {
      ...
      assessment:
        "{{diagnostic_impression}}. PHQ-9: {{phq9_score}}. GAD-7: {{gad7_score}}. Severity: {{severity}}. Risk level: {{risk_level}}.",
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Patient presents for periodic recall exam. Any concerns since last visit: {{concerns}}. Changes to medical history: {{medical_changes}}. Current oral hygiene: {{hygiene_assessment}}.",
      objective:
        "Oral cancer screening: {{ocs_findings}}. Soft tissue: WNL / {{abnormal_findings}}. Hard tissue: {{new_findings}}. Existing restorations: {{restoration_status}}. Periodontal: Probing depths {{probing_summary}}, BOP {{bop_percentage}}%. Radiographs taken: {{radiographs}}. Prophylaxis performed: {{prophy_type}}.",
  ...
  },
  {
    ...
    sections: {
      indication:
        "Tooth #{{tooth_number}}: {{indication}} (caries/fracture/defective restoration). Pre-op diagnosis: {{pre_op_diagnosis}}. Radiographic confirmation: {{radiograph_findings}}.",
      procedure:
        "Anesthesia: {{anesthesia_type}} ({{anesthesia_amount}}). Isolation: {{isolation_method}}. Preparation: {{preparation_description}}. Caries removal: {{caries_extent}} (superficial/moderate/deep). Pulp status: {{pulp_status}}. Liner/base: {{liner_base}}. Restoration: {{restoration_type}} ({{material}}), surfaces: {{surfaces}}. Occlusion adjusted: {{occlusion_check}}. Patient tolerated procedure well.",
      findings:
        "Cavity classification: {{cavity_class}}. Depth: {{depth}}. Margins: {{margin_quality}}. Contact: {{contact_quality}}.",
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Patient presents with {{chief_complaint}} involving tooth #{{tooth_number}} / {{region}}. Duration: {{duration}}. Pain level: {{pain_level}}/10. Character: {{pain_character}} (sharp/dull/throbbing). Aggravated by: {{aggravating_factors}}. Associated symptoms: {{associated_symptoms}} (swelling, fever, difficulty opening). History of trauma: {{trauma_history}}.",
      objective:
        "Extraoral: {{extraoral_findings}} (swelling, asymmetry, lymphadenopathy). Intraoral: Tooth #{{tooth_number}} — {{tooth_findings}}. Percussion: {{percussion}}. Palpation: {{palpation}}. Thermal/EPT: {{vitality_test}}. Mobility: {{mobility}}. Probing: {{probing_depths}}. Radiograph: {{radiographic_findings}}.",
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Patient referred for / presents with periodontal concerns. Chief complaint: {{chief_complaint}}. History of periodontal treatment: {{perio_history}}. Risk factors: {{risk_factors}} (smoking, diabetes, family history). Current home care: {{home_care_routine}}.",
      objective:
      ...
      assessment:
        "Periodontal diagnosis: {{perio_classification}} (Stage {{stage}}, Grade {{grade}}). AAP/EFP classification. Teeth with guarded prognosis: {{guarded_teeth}}.",
  ...
  // ==================== SPECIALTY ====================
  {
    ...
    sections: {
      subjective:
        "Patient returns for follow-up of {{condition}} affecting {{body_part}}. Current pain: {{pain_level}}/10 (was {{prior_pain_level}}/10). Functional status: {{functional_status}}. Physical therapy progress: {{pt_progress}}. Medications: {{current_meds}}.",
      objective:
        "Inspection: {{inspection_findings}}. ROM: {{range_of_motion}}. Strength: {{strength_testing}}. Special tests: {{special_tests}}. Neurovascular: {{neurovascular_status}}. Imaging review: {{imaging_findings}}.",
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Patient presents for {{full_body_or_focused}} skin examination. Concerns: {{concerns}}. History of skin cancer: {{skin_cancer_history}}. Sun exposure history: {{sun_exposure}}. Family history: {{family_history_skin}}. Changes in moles: {{mole_changes}}.",
      objective:
        "Full body skin exam performed. Lesions noted:\n{{lesion_list}}\nDermoscopic findings: {{dermoscopy}}. Scalp: {{scalp}}. Nails: {{nails}}. Mucous membranes: {{mucous_membranes}}.",
    ...
    defaultCodes: [{ code: "99213", description: "Office visit, established, low complexity" }],
  ...
  },
  {
    ...
    sections: {
      subjective:
        "{{age}} {{gender}} presents for well-child visit. Parent concerns: {{parent_concerns}}. Feeding/nutrition: {{nutrition}}. Sleep: {{sleep_pattern}}. Development: {{developmental_milestones}}. Behavior: {{behavior_concerns}}. School performance: {{school_if_applicable}}. Immunization status: {{immunization_review}}.",
      objective:
        "Vitals: Weight {{weight}} ({{weight_percentile}}%), Height {{height}} ({{height_percentile}}%), HC {{head_circ}} ({{hc_percentile}}%), BMI {{bmi}} ({{bmi_percentile}}%). Growth curve: {{growth_trend}}. General: Well-appearing, {{general_appearance}}. HEENT: {{heent}}. Heart: {{heart}}. Lungs: {{lungs}}. Abdomen: {{abdomen}}. GU: {{gu_exam}}. MSK: {{msk}}. Neuro/Dev: {{neuro_dev}}. Skin: {{skin}}. Developmental screening: {{screening_tool}} — {{screening_result}}.",
      assessment:
        "Healthy {{age}} with {{assessments}}. Growth: {{growth_assessment}}. Development: {{developmental_assessment}}.",
  ...
  // ==================== URGENT CARE ====================
  {
    ...
    category: "general",
    description:
      "General urgent care walk-in evaluation for acute complaints requiring same-day assessment and treatment.",
    sections: {
      subjective:
        "Patient presents as a walk-in to urgent care with {{chief_complaint}}. Onset: {{onset}}. Duration: {{duration}}. Severity: {{severity}}/10. Progression: {{progression}} (worsening/stable/improving). Associated symptoms: {{associated_symptoms}}. Pertinent negatives: {{pertinent_negatives}}. Prior self-treatment: {{self_treatment}}. PCP: {{pcp_name}} (last seen: {{last_pcp_visit}}). PMH: {{past_medical_history}}. Medications: {{medications}}. Allergies: {{allergies}}.",
      objective:
        "Vitals: BP {{bp}}, HR {{hr}}, Temp {{temp}}, RR {{rr}}, SpO2 {{spo2}}, Weight {{weight}}. General: {{general_appearance}}. Focused examination: {{focused_exam_findings}}. Point-of-care testing: {{poc_testing}} (rapid strep, flu, COVID, UA, fingerstick glucose). Additional diagnostics: {{additional_diagnostics}} (X-ray, ECG if applicable).",
      assessment:
        "Working diagnosis: {{primary_diagnosis}}. Differential diagnosis: {{differential_diagnoses}}. Acuity: {{acuity_level}} (low/moderate/high). Disposition: {{disposition}} (discharge/observation/ED transfer).",
  ...
  // ==================== BEHAVIORAL HEALTH ====================
  {
    ...
    category: "behavioral_health",
    description:
      "Individual therapy session progress note using DAP format to document therapeutic interventions and client progress.",
    sections: {
  ...
  },
  {
    ...
    category: "behavioral_health",
    description:
      "Group therapy session documentation using DAP format to capture group dynamics, individual participation, and treatment progress.",
    sections: {
    ...
    defaultCodes: [{ code: "90853", description: "Group psychotherapy" }],
  ...
  },
  {
    ...
    category: "general",
    description:
      "Veterinary surgical procedure documentation including anesthesia protocol, surgical technique, and post-operative planning.",
    sections: {
      indication:
        "Pre-operative diagnosis: {{pre_op_diagnosis}}. Reason for surgery: {{surgical_indication}}. Patient: {{species}}, {{breed}}, {{age}}, {{sex}}, {{weight}} {{weight_unit}}. ASA status: {{asa_class}}. Pre-anesthetic bloodwork: {{bloodwork_results}} (CBC, chemistry — {{abnormalities_or_wnl}}). Pre-op exam: {{pre_op_exam}}. NPO status: {{npo_status}} (last meal: {{last_meal}}). Informed consent: obtained from {{owner_name}}, risks discussed including {{risks_discussed}}.",
      procedure:
      ...
      findings:
        "Intra-operative findings: {{intra_op_findings}}. Tissue appearance: {{tissue_appearance}}. Pathology submitted: {{pathology}} (yes/no — {{specimen_description}}). Estimated blood loss: {{ebl}}.",
      complications:
  ...
  // ==================== OB/GYN ====================
  {
    ...
    sections: {
      subjective:
        "{{gravida_para}} at {{gestational_age}} weeks presents for routine prenatal visit. Fetal movement: {{fetal_movement}}. Contractions: {{contractions}}. Vaginal bleeding/discharge: {{bleeding_discharge}}. Headache/visual changes: {{neuro_symptoms}}. Edema: {{edema_report}}. Current complaints: {{complaints}}. Medication compliance: {{medication_adherence}}.",
      objective:
        "Vitals: BP {{bp}}, HR {{hr}}, Weight {{weight}} (gain: {{weight_change}}). Fundal height: {{fundal_height}} cm. Fetal heart tones: {{fhr}} bpm via {{doppler_or_fetoscope}}. Fetal presentation: {{presentation}}. Cervix (if checked): {{cervical_exam}}. Edema: {{edema_exam}}. Urine dip: Protein {{urine_protein}}, Glucose {{urine_glucose}}. Labs reviewed: {{labs_review}}.",
      assessment:
        "{{gravida_para}} at {{gestational_age}} weeks. {{pregnancy_status}} (uncomplicated / high-risk: {{risk_factors}}). {{additional_diagnoses}}.",
  ...
  },
  {
    ...
    sections: {
      subjective:
        "Patient presents for annual gynecologic exam. LMP: {{lmp}}. Menstrual history: {{menstrual_history}} (regularity, flow, dysmenorrhea). Contraception: {{contraceptive_method}}. Sexual history: {{sexual_history}}. STI screening history: {{sti_history}}. Breast complaints: {{breast_complaints}}. Urinary symptoms: {{urinary_symptoms}}. Obstetric history: G{{gravida}}P{{para}}. Surgical history: {{surgical_history}}. Family history: {{family_history}} (breast/ovarian/cervical cancer).",
      objective:
        "Vitals: BP {{bp}}, Weight {{weight}}, BMI {{bmi}}. Breast exam: {{breast_exam}}. Abdomen: {{abdominal_exam}}. External genitalia: {{external_exam}}. Speculum exam: Cervix {{cervix_appearance}}, Vaginal mucosa {{vaginal_exam}}. Bimanual: Uterus {{uterine_exam}}, Adnexa {{adnexal_exam}}. Pap smear: {{pap_collected}} (if indicated). HPV co-test: {{hpv_test}}.",
      assessment:
        "{{assessment}}. Screening status: Cervical cancer screening {{cervical_screening_status}}, Breast cancer screening {{breast_screening_status}}.",
