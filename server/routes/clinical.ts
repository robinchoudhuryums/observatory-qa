  ...
  app.get(
    ...
    asyncHandler(async (req, res) => {
      ...
      try {
        ...
        res.status(503).json({
          message:
            "Unable to decrypt clinical note. PHI encryption key may be misconfigured — contact your administrator.",
  ...
  app.patch(
    ...
    asyncHandler(async (req, res) => {
      ...
      if (wasAttested) {
        ...
        const amendmentType: "amendment" | "section_completion" = isCompletingEmptySections
          ? "section_completion"
          : "amendment";
