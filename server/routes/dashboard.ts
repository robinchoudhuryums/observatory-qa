...
export function registerDashboardRoutes(app: Express): void {
  ...
  app.get("/api/dashboard/usage", requireAuth, injectOrgContext, asyncHandler(async (req, res) => {
  ...
  app.get("/api/dashboard/metrics", requireAuth, injectOrgContext, asyncHandler(async (req, res) => {
  ...
  app.get("/api/dashboard/sentiment", requireAuth, injectOrgContext, asyncHandler(async (req, res) => {
