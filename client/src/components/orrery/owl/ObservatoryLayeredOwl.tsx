...
export function ObservatoryLayeredOwl({ size = 28, color = "currentColor", state = "idle", style }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <path className="obs-owl-body" fillRule="evenodd" d={LAYERED_OWL_BODY} />
        ...
        <path className="obs-owl-beak" d={LAYERED_OWL_BEAK} />
      </g>
    </svg>
  );
}
