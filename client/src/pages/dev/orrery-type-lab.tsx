    ...
    <div style={{ minHeight: "100vh", background: t.bgFlat, color: t.ink }}>
      ...
      <div style={{ padding: 28, display: "grid", gap: 24, maxWidth: 900, margin: "0 auto" }}>
        ...
        <section>
          ...
          <OrreryCard t={t} style={{ marginTop: 12 }}>
            <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: 600, fontSize: 18 }}>
              Inter 600 — UI labels and emphasis.
            </div>
            <div
              style={{
                marginTop: 6,
            ...
            >
              Inter 400 — body paragraphs and helper text. Loaded from Google Fonts via the @import at the top of
              index.css. Falls back to system-ui if the network is down.
            </div>
          </OrreryCard>
        </section>
