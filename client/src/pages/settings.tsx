...
import {
  ...
  Eye, Shield, CheckCircle2, XCircle, Mail, Copy, Clock,
} from "lucide-react";
...
import type { Organization, Invitation } from "@shared/schema";

type TabView = "branding" | "users" | "invitations" | "organization";
