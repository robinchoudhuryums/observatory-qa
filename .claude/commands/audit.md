...
- EHR Integration: server/services/ehr/, server/routes/ehr.ts
- Integrations & External Services: server/services/stripe.ts, server/services/email.ts, server/services/notifications.ts, server/services/telephony-ingestion.ts, server/services/sentry.ts, server/routes/assemblyai-webhook.ts
