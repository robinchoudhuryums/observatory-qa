...
- **Client UI for consent method picker**: `clinical-live.tsx` setup screen needs a "How was consent captured?" picker (verbal/written/electronic). Without it, live clinical sessions cannot be created after the F-12 fix. **High priority — blocks clinical feature usage.**
